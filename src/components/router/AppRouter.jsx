...
//               // { path: true, element: <Navigate to="circle-network" replace /> },
//               { path: "circle-network", element: <CircleNetwork /> },
//               { path: "overview", element: <Overview /> },
//               { path: "business-groups", element: <BusinessGroups /> },
//               { path: "member-reviews", element: <MemberReviews /> },
...
//           {
//             path: "/super-admin-dashboard/form-builder/channelPartner",
//             element: <FormBuilder />
//           },
//         ],
//       },
...
//           {
//             path: "/state-admin-dashboard/communications",
//             element: <CommunicationsLayout />,
//             children: [
//               { index: true, element: <Navigate to="send-campaign" replace /> },
//               { path: "send-campaign", element: <SendCampaign /> },
...
//             ],
//           },
//           { path: "/state-head-dashboard/state-head", element: <StateHead /> },
...
//           {
//             path: "/state-head-dashboard/form-builder/channelPartner",
//             element: <FormBuilder />
//           },
//         ],
//       },
...
//           {
//             path: "/district-admin-dashboard/communications",
//             element: <CommunicationsLayout />,
//             children: [
//               { index: true, element: <Navigate to="send-campaign" replace /> },
//               { path: "send-campaign", element: <SendCampaign /> },
...
//           },
//           {
//             path: "/district-head/business-circle",
//             element: <BusinessCircleLayout />,
//             children: [
//               // { index: true, element: <Navigate to="circle-network" replace /> },
//               { index: true, element: <Navigate to="overview" replace /> },
...
//           { path: "/state-head-dashboard/members/:id", element: <MemberDetailPage /> },
//           { path: "/state-head-dashboard/lead-management", element: <LeadManagement /> },
//           // { path: "/district-head-dashboard/district-head", element: <DistrictHead /> },
...
//           { path: "/district-head-dashboard/membership/role-management", element: <RoleManagement /> },
//           { path: "/district-head-dashboard/cp-onbording", element: <ChannelPartnerOnboard /> },
//           {
//             path: "/district-head-dashboard/form-builder/channelPartner",
//             element: <FormBuilder />
//           },
//         ],
//       },
...
//           {
//             path: "/taluk-admin-dashboard/communications",
//             element: <CommunicationsLayout />,
//             children: [
//               { index: true, element: <Navigate to="send-campaign" replace /> },
//               { path: "send-campaign", element: <SendCampaign /> },
...
//             ],
//           },
//           // { path: "/taluk-head-dashboard/state-head", element: <StateHead /> },
...
//           { path: "/taluk-head-dashboard/user-management", element: <UserManagement /> },
...
//           { path: "/taluk-head-dashboard/membership/role-management", element: <RoleManagement /> },
//           { path: "/taluk-head-dashboard/cp-onbording", element: <ChannelPartnerOnboard /> },
//           {
//             path: "/taluk-head-dashboard/form-builder/channelPartner",
//             element: <FormBuilder />
//           },
//         ],
//       },
...
//           {
//             path: "/wardChairman-admin-dashboard/communications",
//             element: <CommunicationsLayout />,
//             children: [
//               { index: true, element: <Navigate to="send-campaign" replace /> },
//               { path: "send-campaign", element: <SendCampaign /> },
...
//             ],
//           },
//           { path: "/wardChairman-head-dashboard/state-head", element: <StateHead /> },
...
//           {
//             path: "/wardChairman-head-dashboard/form-builder/channelPartner",
//             element: <FormBuilder />
//           },
//         ],
//       },
...
//           { path: "/super-admin-dashboard/area-chart", element: <AreaChartBuilder /> },
//           { path: "/ChannelPartner/area-chart/:wardId", element: <WardChartDetail /> },
//           { path: "/channelPartner-dashboard/profile", element: <Profile /> }, {
//             path: "/channelPartner-head-dashboard/communications",
//             element: <CommunicationsLayout />,
//             children: [
//               { index: true, element: <Navigate to="send-campaign" replace /> },
//               { path: "send-campaign", element: <SendCampaign /> },
...
//             ],
//           },
//           { path: "/channelPartner-dashboard/state-head", element: <StateHead /> },
...
//           {
//             path: "/channelPartner-dashboard/form-builder/channelPartner",
//             element: <FormBuilder />
//           },
//         ],
//       },
...
//           // { path: "/channelPartner-dashboard/members/channelPartners/:id", element: <CpMemberDetails /> },
//           // { path: "/channelPartner-dashboard/members/:id", element: <MemberDetailPage /> },
//           // { path: "/member/lead-management", element: <LeadManagement /> },
//           // { path: "/channelPartner-dashboard/district-head", element: <DistrictHead /> },
//           // { path: "/channelPartner-dashboard/taluk-head", element: <TalukHead /> },
//           // { path: "/channelPartner-dashboard/ward-head", element: <WardHobliHead /> },
//           // { path: "/channelPartner-dashboard/user-management", element: <UserManagement /> },
