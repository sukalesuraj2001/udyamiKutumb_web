...
export const EMPTY_FORM_DATA = {
  ...
  maritalStatus: "Single", primaryMobile: "", whatsappNumber: "", email: "", preferredChannel: "WhatsApp",
  preferredLanguage: "Kannada", bloodGroup: "", education: "", familyIncome: "", currentAddress: "",
  permanentAddress: "", ward: "", circle: "", state: "", pincode: "", languagesKnown: [],
  emergencyContactName: "", emergencyPhone: "", emergencyRelationship: "", govtIdType: "", govtIdNumber: "",

  // Step 2 - Business Info
  ownBusiness: "No", businessName: "", businessType: "", industrySector: "", subCategory: "", businessStage: "Idea",
  yearEstablished: "", annualTurnover: "", employeeCount: "", gstRegistration: "No", gstNumber: "",
  msmeRegistration: "No", targetCustomer: "B2B", primaryProducts: "", geographicMarkets: "", salesChannels: "",
  sellsOnline: "No", businessWebsite: "", bankAccount: "No", onlineSalesChannels: [], biggestChallenges: [],
  supportNeeded: [], takenBusinessLoan: "", seekingFunding: "",

  // Step 3 - Skills & Interests
  fieldOfStudy: "", certifications: "", skillProficiency: "Beginner", yearsExperience: "", salesExpertise: "No",
  digitalMarketingSkill: "No", financialSkills: "No", itTechSkills: "No", publicSpeaking: "No",
  contentCreation: "No", culinarySkills: "No", artCraftSkills: "No", professionalSkills: [],
  interests: [], wantNewSkills: "Yes", willingToMentor: "No", openToCollaborate: "Yes", tags: [],
  ...
  wantMentor: "No", willingToMentor: "No",
