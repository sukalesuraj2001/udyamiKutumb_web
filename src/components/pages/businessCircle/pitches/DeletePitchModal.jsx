...
export default function DeletePitchModal({ pitch, onClose, onConfirm }) {
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <div className="relative w-full max-w-sm bg-white rounded-2xl shadow-2xl p-6">
        ...
        <h2 className="text-[16px] font-semibold text-ink mb-1.5">Delete this pitch?</h2>
        <p className="text-[13.5px] text-muted mb-6">
          <span className="font-medium text-ink">{pitch?.name}</span>'s pitch will be permanently removed from the wall.
        </p>
